...
mysql -e "CREATE FUNCTION SELECT get_first_record_timestamp_by_binlog RETURNS TIMESTAMP SONAME 'binlog_utils_udf.so';"
mysql -e "CREATE FUNCTION SELECT get_last_record_timestamp_by_binlog RETURNS TIMESTAMP SONAME 'binlog_utils_udf.so';"
