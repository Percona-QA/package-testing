...
pxc80_files = (
  'lib/libgalera_smm.so', 'lib/libperconaserverclient.a', 'lib/libperconaserverclient.so.21.2.27' ,
...
pxc80_symlinks = (
  ...
  ('lib/libperconaserverclient.so','lib/libperconaserverclient.so.21.2.27'), ('lib/libplc4.so','lib/private/libplc4.so'),
...
pxc57_files = (
  'lib/libgalera_smm.so', 'lib/libperconaserverclient.a', 'lib/libperconaserverclient.so.20.3.24' ,
