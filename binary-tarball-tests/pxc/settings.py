...
pxc80_files = (
  'lib/libgalera_smm.so', 'lib/libperconaserverclient.a', 'lib/libperconaserverclient.so.21.2.33' ,
...
if glibc_version == '2.35':
  pxc80_symlinks = (
    ...
    ('lib/libperconaserverclient.so', 'lib/libperconaserverclient.so.21.2.33'),('lib/libsasl2.so', 'lib/private/libsasl2.so.2.0.25'),
  ...
  pxc80_symlinks = (
    ...
    ('lib/libperconaserverclient.so','lib/libperconaserverclient.so.21.2.33'), ('lib/libplc4.so','lib/private/libplc4.so'),
...
pxc57_files = (
  'lib/libgalera_smm.so', 'lib/libperconaserverclient.a', 'lib/libperconaserverclient.so.20.3.30' ,
