...
if glibc_version == '2.35':
  ...
  pxc8x_symlinks = (
    ('lib/libgcrypt.so','lib/private/libgcrypt.so.20.3.4'), ('lib/libnspr4.so','lib/private/libnspr4.so'),
    ...
    ('lib/libssl3.so','lib/private/libssl3.so'), ('lib/libtinfo.so','lib/private/libtinfo.so.6.3'),
  )
pxc8x_components = (
