...
ps80_files = (
  'lib/libcoredumper.a', 'lib/libHotBackup.so', 'lib/mysqlrouter/private/libmysqlrouter_http.so.1',
  'lib/mysqlrouter/private/libmysqlrouter.so.1', 'lib/libmysqlservices.a',
  'lib/libperconaserverclient.a', 'lib/libperconaserverclient.so.21.2.27' ,'lib/mysql/libjemalloc.so.1',
  'lib/plugin/ha_rocksdb.so', 'lib/plugin/audit_log.so', 'lib/plugin/auth_pam.so',
  'lib/plugin/auth_pam_compat.so', 'lib/plugin/data_masking.so', 'lib/plugin/data_masking.ini',
  'lib/plugin/keyring_file.so', 'lib/plugin/keyring_udf.so', 'lib/plugin/keyring_vault.so', 'lib/plugin/binlog_utils_udf.so'
)
ps80_symlinks = (
...
ps57_files = (
  ...
  'lib/libperconaserverclient.a', 'lib/libperconaserverclient.so.20.3.24' ,'lib/mysql/libjemalloc.so.1',
...
ps57_symlinks = (
  ('lib/libperconaserverclient.so.20','lib/libperconaserverclient.so.20.3.24'),
  ('lib/libperconaserverclient.so','lib/libperconaserverclient.so.20.3.24')
)
