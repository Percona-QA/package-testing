...
ps80_files = (
  ...
  'lib/libperconaserverclient.a', 'lib/libperconaserverclient.so.21.1.26' ,'lib/mysql/libjemalloc.so.1',
...
ps80_symlinks = (
  ('lib/libperconaserverclient.so.21','lib/libperconaserverclient.so.21.1.26'),
  ('lib/libperconaserverclient.so','lib/libperconaserverclient.so.21.1.26'),('lib/mysql/libjemalloc.so','lib/mysql/libjemalloc.so.1')
)
