...
if [ -z "$1" ]; then
  echo "This script needs parameter 3.6|4.0|4.2|4.4 and keyfile|vault"
  exit 1
elif [ "$1" != "3.6" -a "$1" != "4.0" -a "$1" != "4.2" -a "$1" != "4.4" -a "$1" != "5.0" ]; then
...
if [ "${VERSION}" == "4.4" -a "${KEY_STORE}" == "keyfile" ]; then
  # 4.4 CBC
  rm -f ${ROLLBACK_DIR}/44-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-decrypted
  rm -f ${ROLLBACK_DIR}/44-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-json
  perconadecrypt --encryptionKeyFile ${KEY_FILE} --encryptionCipherMode AES256-CBC --inputPath ${ROLLBACK_DIR}/44-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc --outputPath ${ROLLBACK_DIR}/44-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-decrypted

  bsondump --bsonFile ${ROLLBACK_DIR}/44-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-decrypted --outFile ${ROLLBACK_DIR}/44-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-json

  pushd ${ROLLBACK_DIR}/44-cbc/ycsb_test.usertable
  md5sum -c ${ROLLBACK_DIR}/44-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-json.md5
  popd

  # 4.4 GCM
  rm -f ${ROLLBACK_DIR}/44-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-decrypted
  rm -f ${ROLLBACK_DIR}/44-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-json
  perconadecrypt --encryptionKeyFile ${KEY_FILE} --encryptionCipherMode AES256-GCM --inputPath ${ROLLBACK_DIR}/44-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm --outputPath ${ROLLBACK_DIR}/44-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-decrypted

  bsondump --bsonFile ${ROLLBACK_DIR}/44-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-decrypted --outFile ${ROLLBACK_DIR}/44-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-json
...
if [ "${VERSION}" == "4.4" -a "${KEY_STORE}" == "vault" ]; then
  # 4.4 CBC
  rm -f ${ROLLBACK_DIR}/44-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-decrypted
  rm -f ${ROLLBACK_DIR}/44-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-json
  perconadecrypt --encryptionCipherMode AES256-CBC --vaultServerName 10.30.6.213 --vaultPort 8200 --vaultTokenFile ${TOKEN_FILE} --vaultSecret ${VAULT_SECRET} --vaultServerCAFile ${CA_FILE} --inputPath ${ROLLBACK_DIR}/44-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc --outputPath ${ROLLBACK_DIR}/44-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-decrypted
  ...
  rm -f ${ROLLBACK_DIR}/44-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-decrypted
  rm -f ${ROLLBACK_DIR}/44-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-json
  perconadecrypt --encryptionCipherMode AES256-GCM --vaultServerName 10.30.6.213 --vaultPort 8200 --vaultTokenFile ${TOKEN_FILE} --vaultSecret ${VAULT_SECRET} --vaultServerCAFile ${CA_FILE} --inputPath ${ROLLBACK_DIR}/44-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm --outputPath ${ROLLBACK_DIR}/44-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-decrypted
...
if [ "${VERSION}" == "5.0" -a "${KEY_STORE}" == "keyfile" ]; then
  # 5.0 CBC
  rm -f ${ROLLBACK_DIR}/50-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-decrypted
  rm -f ${ROLLBACK_DIR}/50-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-json
  perconadecrypt --encryptionKeyFile ${KEY_FILE} --encryptionCipherMode AES256-CBC --inputPath ${ROLLBACK_DIR}/50-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc --outputPath ${ROLLBACK_DIR}/50-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-decrypted

  bsondump --bsonFile ${ROLLBACK_DIR}/50-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-decrypted --outFile ${ROLLBACK_DIR}/50-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-json

  pushd ${ROLLBACK_DIR}/50-cbc/ycsb_test.usertable
  md5sum -c ${ROLLBACK_DIR}/50-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-json.md5
  popd

  # 5.0 GCM
  rm -f ${ROLLBACK_DIR}/50-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-decrypted
  rm -f ${ROLLBACK_DIR}/50-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-json
  perconadecrypt --encryptionKeyFile ${KEY_FILE} --encryptionCipherMode AES256-GCM --inputPath ${ROLLBACK_DIR}/50-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm --outputPath ${ROLLBACK_DIR}/50-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-decrypted

  bsondump --bsonFile ${ROLLBACK_DIR}/50-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-decrypted --outFile ${ROLLBACK_DIR}/50-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-json

  pushd ${ROLLBACK_DIR}/50-gcm/ycsb_test.usertable
  md5sum -c ${ROLLBACK_DIR}/50-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-json.md5
  popd
fi

if [ "${VERSION}" == "5.0" -a "${KEY_STORE}" == "vault" ]; then
  # 5.0 CBC
  rm -f ${ROLLBACK_DIR}/50-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-decrypted
  rm -f ${ROLLBACK_DIR}/50-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-json
  perconadecrypt --encryptionCipherMode AES256-CBC --vaultServerName 10.30.6.213 --vaultPort 8200 --vaultTokenFile ${TOKEN_FILE} --vaultSecret ${VAULT_SECRET} --vaultServerCAFile ${CA_FILE} --inputPath ${ROLLBACK_DIR}/50-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc --outputPath ${ROLLBACK_DIR}/50-cbc/ycsb_test.usertable/removed.2019-09-03T06-33-05.0.bson.aes256-cbc-decrypted
  ...
  rm -f ${ROLLBACK_DIR}/50-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-decrypted
  rm -f ${ROLLBACK_DIR}/50-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-json
  perconadecrypt --encryptionCipherMode AES256-GCM --vaultServerName 10.30.6.213 --vaultPort 8200 --vaultTokenFile ${TOKEN_FILE} --vaultSecret ${VAULT_SECRET} --vaultServerCAFile ${CA_FILE} --inputPath ${ROLLBACK_DIR}/50-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm --outputPath ${ROLLBACK_DIR}/50-gcm/ycsb_test.usertable/removed.2019-09-03T08-03-44.0.bson.aes256-gcm-decrypted
