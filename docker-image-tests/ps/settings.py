...
ps80_binaries = (
  ...
  '/usr/bin/grep', '/usr/bin/cut', '/usr/bin/tail', '/usr/bin/sed', '/usr/bin/find', '/usr/bin/kill', '/usr/bin/awk'
)
ps80_plugins = (
...
ps80_component =(
  ('component_keyring_kmip'),('component_keyring_kms'),('component_encryption_udf')
)
ps80_functions = (
