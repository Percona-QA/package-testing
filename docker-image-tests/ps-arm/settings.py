...
ps97_binaries = (
  ...
  '/usr/bin/mysql_secure_installation', '/usr/bin/sed', '/usr/bin/find', '/usr/bin/hostname', '/usr/bin/gunzip', '/usr/bin/my_print_defaults',
  '/usr/bin/mysql_tzinfo_to_sql', '/usr/bin/grep', '/usr/bin/sed', '/usr/bin/gawk', '/usr/bin/mysqlsh'
)
ps97_plugins = (
