...
container_name = 'haproxy-docker-test-inspect'
...
class TestContainerAttributes:
    def test_args(self, inspect_data):
        ...
        assert inspect_data['Args'][0] == 'haproxy'
    ...
    def test_config(self, inspect_data):
        ...
        assert inspect_data['Config']['Cmd'][0] == 'haproxy'
    ...
    def test_volumes(self, inspect_data):
        ...
        assert '/etc/haproxy/pxc' in inspect_data['Config']['Volumes']
